...
plot_resolution_vs_energy(resolutions, detector_name='BGO')
...
Am_angular = fit_off_axis_response("Foreigners/BGO/AM_offaxis", "Am", background, 22,on_axis_file='Foreigners/BGO/AM_aligned.Spe')
plot_off_axis_response((Am_angular), 'AM241',59.54)

cs_angular_FWHM = fit_off_axis_response_FWHM("Foreigners/BGO/CS_offaxis", "Cs", background, 300,on_axis_file='Foreigners/BGO/CS137_aligned.Spe')
plot_off_axis_response_FWHM((cs_angular_FWHM), 'CS137',661.57)

AM_angular_FWHM = fit_off_axis_response_FWHM("Foreigners/BGO/AM_offaxis", "Am", background, 22,on_axis_file='Foreigners/BGO/AM_aligned.Spe')
