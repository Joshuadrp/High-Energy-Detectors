...
# Load data
cs137 = load_spe(f"{base_path}/CS137_aligned.mca")
co60 = load_spe(f"{base_path}/CO60_aligned.mca")
am241 = load_spe(f"{base_path}/AM_aligned.mca")
ba133 = load_spe(f"{base_path}/BA_aligned.mca")
background = load_spe(f"{base_path}/BACKGROUND.mca")


# Subtract background
print("Subtracting background...")
cs137_no_bg = cs137 #subtract_background(cs137, background)
co60_no_bg = co60 #subtract_background(co60, background)
am241_no_bg = am241 #subtract_background(am241, background)
ba133_no_bg = ba133 #subtract_background(ba133, background)

# Fit and plot peaks
cs137_fit = plot_spectrum_with_fit(cs137_no_bg, "CS-137", peak_channel=990)
