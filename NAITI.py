...
# def isotope_fit_energy_uncertainty(i_energy, i_counts, title, peak):
#     plot_spectrum_with_fit_energy(energy=i_energy, y=i_counts, title=f"{title}", peak_channel=peak)
